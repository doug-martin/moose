...
var inequalityMethod = function(op) {
    return function(expression) {
        if (comb.isInstanceOf(expression, BooleanExpression)
            ...
            || (comb.isObject(expression) && !comb.isInstanceOf(Expression))
...
var StringMethods = comb.define(null, {
    instance : {
        ...
        ilike : function(expression) {
            return StringExpression.like(this, expression, {caseInsensitive : true});
        },
        ...
        like : function(expression) {
            return StringExpression.like(this, expression, {caseInsensitive : false});
        }
    }
...
var VirtualRowBlock = comb.define(null, {
    instance : {
        eval : function(cb) {
            try {
                cb.call(this);
            } catch(e) {
                var prop = e.arguments[0];
                var t = {};
                t[prop] = new Identifier(prop);
                this.eval.call(t, cb);
            }
        }
    }
}).export(sql, "VirtualRowBlock");
    ...
    instance : {
        ...
        constructor : function(conditions, def, expression) {
            if (!Expression.isConditionSpecifier(conditions)) {
                throw new ExpressionError("CaseExpression conditions must be an object or an array of two pairs");
            } else {
        ...
        fromValuePairs : function(a, op, negate) {
            ...
            for (var k in a) {
                ...
                if (comb.isArray(v) || comb.isInstanceOf(v, Dataset)) {
                    ...
                    ret = new BooleanExpression("EQ", k, v);
                }
...
var Constants = {
    ...
    SQLTRUE : new BooleanConstant(true),
    TRUE : new BooleanConstant(true),
    SQLFALSE : new BooleanConstant(false),
...
var SQLFunction = comb.define(GenericExpression, {
    instance : {
        constructor: function(f) {
            var args = comb.argsToArray(arguments).slice(1);
            this.__f = f,this.__args = args.map(function(a) {
...
var NumericExpression = comb.define([ComplexExpression,BitWiseMethods,NumericMethods, InequalityMethods, NoBooleanInputMethods]);
...
var Time = function(h, m, s, ms) {
    Date.apply(this, [0,0,0, h, m, s, ms]);
};

Time.prototype = Object.create(Date, {});
exports.Time = Time;
...
Year.prototype = Object.create(Date, {});
exports.Year = Year;

DateTime.prototype = Object.create(Date, {});
...
TimeStamp.prototype = Object.create(Date, {});
exports.TimeStamp = TimeStamp;


comb.merge(exports, Constants);
