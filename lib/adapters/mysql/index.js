var Client = require("mysql").Client,
        ...
        hitch = comb.hitch,
        mysqlTypes = require("./types"),
        Table = require("../../table.js").Table,
        MySQLClient = require("./client"),
        SQL = require("../sql.js");
...
/**
 * @class mysql implementaton of {@link SQL} this class exposes all MySql relevant functionality.
 * <p>You should not have to use this class directly, but will be exposed for you by specifying the type when initializing moose.createConnection</p>
 *
 * @name mysql
 * @augments SQL
 * @memberOf moose.adapters
 */
