...
module.exports = exports = comb.define(null, {
    instance : {
         ...
         */
        is: function(options) {
            if (typeof options != "object") throw new Error("options must be an object {key : value} when using is");
            return this.__isOp("is", options);
        },
        ...
        isNot: function(options) {
            if (typeof options != "object") throw new Error("options must be an object {key : value} when using isNot");
            return this.__isOp("isNot", options);
        },
        ...
        isNull: function(options) {
            if (typeof options != "string") throw new Error("options must be a string <columnName> when using isNull");
            return this.__isOp("isNull", options);
        },
        ...
        isNotNull: function(options) {
            if (typeof options != "string") throw new Error("options must be a string <columnName> when using isNotNull");
            return this.__isOp("isNotNull", options);
        },
        ...
        neq: function(options) {
            return this._booleanOp("neq", options);
        },
        ...
        fullOuterJoin: function(tableName, options) {
            return this._joinOp("fullOuterJoin", table, options);
        },
        ...
        rightOuterJoin: function(tableName, options) {
            return this._joinOp("rightOuterJoin", table, options);
        },
        ...
        leftOuterJoin: function(tableName, options) {
            return this._joinOp("leftOuterJoin", table, options);
        },
        ...
        fullJoin: function(tableName, options) {
            return this._joinOp("fullJoin", table, options);
        },
        ...
        rightJoin: function(tableName, options) {
            return this._joinOp("rightJoin", table, options);
        },
        ...
        leftJoin: function(tableName, options) {
            return this._joinOp("leftJoin", table, options);
        },
        ...
        naturalJoin: function(tableName) {
            return this._joinOp("naturalJoin", tableName);
        },
        ...
        naturalLeftJoin: function(tableName) {
            return this._joinOp("naturalLeftJoin", tableName);
        },
        ...
        naturalRightJoin: function(tableName) {
            return this._joinOp("naturalRightJoin");
        },
        naturalFullJoin: function(tableName) {
            return this._joinOp("naturalFullJoin", tableName);
        },
        ...
        crossJoin: function(tableName) {
            return this._joinOp("crossJoin", tableName);
        },
        ...
        notIn: function(options) {
            return this._inOp("notIn", options);
        },
        ...
        between: function(options) {
            return this._betweenOp("between", options);
        },
        ...
        notBetween: function(options) {
            return this._inOp("notBetween", options);
        },
